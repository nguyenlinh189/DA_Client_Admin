...
public class StatController {
	...
	private String getListUsedServiceLoc(HttpSession session, @RequestParam(name="status", defaultValue = "ALL")String status, Model model) {
		...
		if(status.equalsIgnoreCase("all"))
			return "redirect:/stat/getListUsedService";
		return "manageStat/listUsedService.html";
	}
}
